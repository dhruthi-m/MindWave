...
import { schizophreniaInsightsMockData } from './schizophreniaInsightsMockData';

export default function SchizophreniaInsights({ 
  onBack, 
  onRetake, 
  onHome, 
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-slate-100 font-sans p-4 sm:p-8 md:p-10 w-full max-w-7xl mx-auto flex flex-col gap-8 transition-colors duration-300">
        ...
        <div className="flex items-center gap-4 w-full lg:w-auto">
          <div className="text-xs sm:text-sm text-slate-400 bg-slate-900/40 px-4 py-2.5 rounded-[16px] border border-slate-800/60 flex flex-col gap-1 w-full lg:w-auto min-w-[220px] text-left">
            <div className="flex justify-between gap-4">
              ...
              <span className="font-bold text-blue-400">Prodromal (PQ-16)</span>
            </div>
            <div className="flex justify-between gap-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
        ...
        {/* PQ-16 Trend Chart Card (Col Span 7) */}
          ...
          <div className="flex justify-between items-center border-b border-slate-800/60 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 mt-0.5">Prodromal screening symptom count mapped historically</p>
              </div>
            </div>
